...
recConstructor ::
  forall a.
  { constructor :: TermBinding -> List Parameter -> ConstructorMetadata -> Context -> WrapI Parameter -> MetaContext -> a
  } ->
...
recTerm ::
  ...
  , match :: TypeID -> Term -> List Case -> MatchTermMetadata -> Context -> Type -> Wrap Term -> WrapI Case -> MetaContext -> a
  } ->
