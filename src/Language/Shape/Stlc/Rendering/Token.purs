...
token =
  ...
  , lam1: DOM.span [ Props.className "token" ] [ DOM.text "fun " ]
  , lam2: DOM.span [ Props.className "token" ] [ DOM.text " => " ]
  , data1: DOM.span [ Props.className "token" ] [ DOM.text "type " ]
  , data2: DOM.span [ Props.className "token" ] [ DOM.text " = " ]
  , data3: DOM.span [ Props.className "token" ] [ DOM.text " in " ]
  , neu1: DOM.span [ Props.className "token" ] [ DOM.text " " ]
  , let1: DOM.span [ Props.className "token" ] [ DOM.text "let " ]
  , let2: DOM.span [ Props.className "token" ] [ DOM.text " : " ]
  , let3: DOM.span [ Props.className "token" ] [ DOM.text " = " ]
  , let4: DOM.span [ Props.className "token" ] [ DOM.text " in " ]
  , buf1: DOM.span [ Props.className "token" ] [ DOM.text "buf " ]
  , buf2: DOM.span [ Props.className "token" ] [ DOM.text " : " ]
  , buf3: DOM.span [ Props.className "token" ] [ DOM.text " in " ]
  , match1: DOM.span [ Props.className "token" ] [ DOM.text "match " ]
  , match2: DOM.span [ Props.className "token" ] [ DOM.text "with " ]
  , sumItem1: DOM.span [Props.className "token"] [DOM.text "| "]
  , sumItem2: DOM.span [Props.className "token"] [DOM.text " of "]
