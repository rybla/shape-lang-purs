...
token =
  ...
  , let4: DOM.span [ Props.className "token delimiter" ] [ DOM.text " ; " ]
  ...
  , buf3: DOM.span [ Props.className "token delimiter" ] [ DOM.text " ; " ]
  ...
  , caseItem3: DOM.span [ Props.className "token" ] [ DOM.text " ⇒ " ]
