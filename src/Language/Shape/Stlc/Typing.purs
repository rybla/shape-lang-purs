...
-- -- -- typeOfNeutralTerm gamma (ApplicationTerm (TermReference id _) Nil _) = case (Map.lookup' id gamma) of
-- -- --   ArrowType prms beta -> beta
-- -- --   _ -> Unsafe.error "impossible"
-- -- -- typeOfNeutralTerm gamma (NeutralTerm a) = case (Map.lookup' undefined gamma) of
