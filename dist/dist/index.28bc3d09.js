                ...
                return function(xs) {
                    var v = function() {
                        var rev = Data_Foldable.foldl(foldableList)(function(v1) {
                            return function(a) {
                                return new Data_Tuple.Tuple(v1.value0 + 1 | 0, new Cons1(a, v1.value1));
                            };
                        });
                        return rev(new Data_Tuple.Tuple(0, Nil1.value))(xs);
                    }();
...
(function($PS) {
    ...
    // not necessarily unique
    var ConstrName1 = function() {
        function ConstrName(value0) {
            this.value0 = value0;
        }
        ConstrName.create = function(value0) {
            return new ConstrName(value0);
        };
        return ConstrName;
    }();
    var DataType1 = function() {
    ...
    exports["TermDefinition"] = TermDefinition1;
    exports["DataDefinition"] = DataDefinition1;
    exports["ArrowType"] = ArrowType1;
    exports["BaseType"] = BaseType1;
    exports["DataType"] = DataType1;
    exports["HoleType"] = HoleType1;
    exports["LambdaTerm"] = LambdaTerm1;
    exports["NeutralTerm"] = NeutralTerm1;
    exports["HoleTerm"] = HoleTerm1;
    exports["VarName"] = VarName1;
    exports["ConstrName"] = ConstrName1;
})(PS);
(function(exports) {
...
(function($PS) {
    ...
    var addUniqueTypeBinding = Undefined["undefined"];
    var addUniqueTermBinding = Undefined["undefined"];
    var addDefinitions = function(defs) {
        return function(gamma) {
            var f = function(gamma1) {
                return function(v) {
                    if (v instanceof Language_Shape_Stlc_Syntax.TermDefinition) return addUniqueTermBinding(v.value0)(v.value1)(gamma1);
                    if (v instanceof Language_Shape_Stlc_Syntax.DataDefinition) return addUniqueTypeBinding(v.value0)(gamma1);
                    throw new Error("Failed pattern match at Language.Shape.Stlc.Context (line 49, column 3 - line 49, column 74): " + [
                        gamma1.constructor.name,
                        v.constructor.name
                    ]);
                };
            };
            return Data_Foldable.foldl(Data_List_Types.foldableList)(f)(gamma)(defs);
        };
    };
...
(function($PS) {
    ...
    var Data_List_Types = $PS["Data.List.Types"];
    var Data_Semigroup = $PS["Data.Semigroup"];
    var IndexStep_Definition1 = function() {
    ...
    var IndexStep_Parameter1 = function() {
    ...
    var IndexStep_UniqueTermBinding1 = function() {
    ...
    var IndexStep_TermBinding1 = function() {
    ...
    var IndexStep_TypeReference1 = function() {
    ...
    exports["IndexStep_Definition"] = IndexStep_Definition1;
    exports["IndexStep_Type"] = IndexStep_Type1;
    exports["IndexStep_Term"] = IndexStep_Term1;
    exports["IndexStep_Constructor"] = IndexStep_Constructor1;
    exports["IndexStep_Parameter"] = IndexStep_Parameter1;
    exports["IndexStep_Output"] = IndexStep_Output1;
    exports["IndexStep_Block"] = IndexStep_Block1;
    exports["IndexStep_Argument"] = IndexStep_Argument1;
    exports["IndexStep_UniqueTermBinding"] = IndexStep_UniqueTermBinding1;
    exports["IndexStep_TermBinding"] = IndexStep_TermBinding1;
    exports["IndexStep_TermReference"] = IndexStep_TermReference1;
    exports["IndexStep_TermLabel"] = IndexStep_TermLabel1;
    exports["IndexStep_UniqueTypeBinding"] = IndexStep_UniqueTypeBinding1;
    exports["IndexStep_TypeReference"] = IndexStep_TypeReference1;
...
(function($PS) {
        ...
        return function(gamma) {
            return function(ix) {
                return Halogen_HTML_Elements.div([
                    Halogen_HTML_Properties.class_("typeReference")
                ])([
                    renderTypeName(v.value0)
                ]);
            };
        };
    };
    var renderUniqueTypeBinding = function(v) {
        return function(gamma) {
            return function(ix) {
                return Halogen_HTML_Elements.div([
                    Halogen_HTML_Properties.class_("uniqueTypeBinding")
                ])([
                    renderTypeName(v.value0)
                ]);
            };
    ...
    var renderTermName = function(v) {
        if (v instanceof Language_Shape_Stlc_Syntax.VarName) return Halogen_HTML_Core.text(v.value0);
        if (v instanceof Language_Shape_Stlc_Syntax.ConstrName) return Halogen_HTML_Core.text(v.value0);
        throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 199, column 1 - line 199, column 54): " + [
            v.constructor.name
        ]);
    };
    var renderUniqueTermBinding = function(v) {
        return function(gamma) {
            return function(ix) {
                return Halogen_HTML_Elements.div([
                    Halogen_HTML_Properties.class_("uniqueTermBinding")
                ])([
                    renderTermName(v.value0)
                ]);
            };
        };
    };
    var renderTermLabel = function(v) {
        return function(gamma) {
            return function(ix) {
                return Halogen_HTML_Elements.div([
                    Halogen_HTML_Properties.class_("termLabel")
                ])([
                    renderTermName(v.value0)
                ]);
            };
    ...
    var renderTermId = function(dictPartial) {
        return function(id) {
            return function(gamma) {
                return renderTermName(Data_Maybe.fromJust()(Data_Map_Internal.lookup(Data_Ord.ordInt)(id)(gamma.termIdName)));
            };
        };
    };
    var renderTermReference = function(dictPartial) {
        return function(v) {
            return function(gamma) {
                return function(ix) {
                    return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("termReference")
                    ])([
                        renderTermId()(v.value0)(gamma)
                    ]);
                };
            };
        };
    ...
    var renderTermBinding = function(dictPartial) {
        return function(v) {
            return function(gamma) {
                return function(ix) {
                    return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("termBinding")
                    ])([
                        renderTermId()(v.value0)(gamma)
                    ]);
                };
    ...
    var punctuations = function() {
        var makePunctuation = function(title) {
            return function(punc) {
                return new Data_Tuple.Tuple(title, Halogen_HTML_Elements.div([
                    Halogen_HTML_Properties.class_(title + "punctuation")
                ])([
                    Halogen_HTML_Core.text(punc)
                ]));
            };
        };
        return Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.uncurry(makePunctuation))([
            new Data_Tuple.Tuple("period", "."),
            new Data_Tuple.Tuple("comma", ","),
            new Data_Tuple.Tuple("colon", ":"),
            new Data_Tuple.Tuple("lparen", "("),
            new Data_Tuple.Tuple("rparen", ")"),
            new Data_Tuple.Tuple("alt", "|"),
            new Data_Tuple.Tuple("arrow", "->"),
            new Data_Tuple.Tuple("assign", ":="),
            new Data_Tuple.Tuple("mapsto", "=>"),
            new Data_Tuple.Tuple("space", " "),
            new Data_Tuple.Tuple("indent", "  ")
        ]))([
            new Data_Tuple.Tuple("newline", Halogen_HTML_Elements.br_)
        ]));
    }();
    var renderPunctuation = function(dictPartial) {
        return function(title) {
            return Data_Maybe.fromJust()(Data_Map_Internal.lookup(Data_Ord.ordString)(title)(punctuations));
        };
    };
    var makeIntercalater = function(dictPartial) {
        return function(inter) {
            var $122 = Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray);
            var $123 = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_List_Types.monoidList)(inter);
            var $124 = Data_Functor.map(Data_List_Types.functorList)(Data_List.singleton);
            return function($125) {
                return Halogen_HTML_Elements.map_($122($123($124($125))));
            };
        };
    };
    var keywords = function() {
        var makeKeyword = function(title) {
            return new Data_Tuple.Tuple(title, Halogen_HTML_Elements.div([
                Halogen_HTML_Properties.class_(title + "keyword")
            ])([
                Halogen_HTML_Core.text(title)
            ]));
        };
        return Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(makeKeyword)([
            "data",
            "match",
            "with",
            "let"
    ...
    var renderKeyword = function(dictPartial) {
        return function(title) {
            return Data_Maybe.fromJust()(Data_Map_Internal.lookup(Data_Ord.ordString)(title)(keywords));
        };
    };
    var intercalateNewlines = function(dictPartial) {
        return makeIntercalater()(Data_List.fromFoldable(Data_Foldable.foldableArray)([
            renderPunctuation()("newline")
        ]));
    };
    var intercalateCommas = function(dictPartial) {
        return makeIntercalater()(Data_List.fromFoldable(Data_Foldable.foldableArray)([
            renderPunctuation()("comma"),
    ...
    var renderType = function(dictPartial) {
        return function(v) {
            return function(gamma) {
                return function(ix) {
                    if (v instanceof Language_Shape_Stlc_Syntax.ArrowType) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("arrow type")
                    ])([
                        renderPunctuation()("lparen"),
                        intercalateCommas()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function(i) {
                            return function(prm) {
                        ...
                        renderPunctuation()("space"),
                        renderType()(new Language_Shape_Stlc_Syntax.BaseType(v.value1))(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Output.value))
                    ]);
                    if (v instanceof Language_Shape_Stlc_Syntax.BaseType && v.value0 instanceof Language_Shape_Stlc_Syntax.DataType) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("data type")
                    ])([
                        renderTypeReference(v.value0.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_TypeReference.value))
                    ]);
                    if (v instanceof Language_Shape_Stlc_Syntax.BaseType && v.value0 instanceof Language_Shape_Stlc_Syntax.HoleType) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("hole type")
                    ])([
                        renderHoleId(v.value0.value0)
                    ]);
                    throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 92, column 1 - line 92, column 77): " + [
                        v.constructor.name,
                        gamma.constructor.name,
                        ix.constructor.name
                    ]);
                };
            };
    ...
    var renderParameter = function(dictPartial) {
        return function(v) {
            return function(gamma) {
                return function(ix) {
                    return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("parameter")
                    ])([
                        renderTermLabel(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_TermLabel.value)),
                        renderPunctuation()("colon"),
                        renderPunctuation()("space"),
                        renderType()(v.value1)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Type.value))
                    ]);
                };
            };
        };
    ...
    var renderConstructor = function(dictPartial) {
        return function(v) {
            return function(gamma) {
                return function(ix) {
                    var $82 = Data_List.length(v.value1) === 0;
                    if ($82) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("constructor")
                    ])([
                        renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value))
                    ]);
                    return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("constructor")
                    ])([
                        renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value)),
                        renderPunctuation()("lparen"),
                        intercalateAlts()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function(i) {
                            return function(prm) {
                                return renderParameter()(prm)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_Parameter(i)));
                            };
                        })(v.value1)),
    ...
    var renderTerm = function(dictPartial) {
        return function(v) {
            return function(v1) {
                return function(gamma) {
                    return function(ix) {
                        if (v instanceof Language_Shape_Stlc_Syntax.LambdaTerm) return Halogen_HTML_Elements.div([
                            Halogen_HTML_Properties.class_("lambda term")
                        ])([
                            renderPunctuation()("lparen"),
                            intercalateCommas()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function(i) {
                                return function(x) {
                            ...
                            renderPunctuation()("space"),
                            renderPunctuation()("arrow"),
                            renderBlock()(v.value1)(v1)(Undefined["undefined"])(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Block.value))
                        ]);
                        if (v instanceof Language_Shape_Stlc_Syntax.NeutralTerm && v1 instanceof Language_Shape_Stlc_Syntax.ArrowType) return Halogen_HTML_Elements.div([
                            Halogen_HTML_Properties.class_("neutral term")
                        ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([
                            renderTermReference()(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_TermReference.value))
                        ])(function() {
                            var $91 = Data_List.length(v.value1) === 0;
                            if ($91) return [];
                            return [
                                renderPunctuation()("lparen"),
                                intercalateCommas()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function(i) {
                                    return function(a) {
                                        return renderTerm()(a)(function() {
                                            var v2 = Data_Maybe.fromJust()(Data_List.index(v1.value0)(i));
                                            return v2.value1;
                        ...
                        if (v instanceof Language_Shape_Stlc_Syntax.HoleTerm) return Halogen_HTML_Elements.div([
                            Halogen_HTML_Properties.class_("hole term")
                        ])([
                            renderHoleId(v.value0)
                        ]);
                        throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 131, column 1 - line 131, column 85): " + [
                            v.constructor.name,
                            v1.constructor.name,
                            gamma.constructor.name,
                            ix.constructor.name
    ...
    var renderDefinition = function(dictPartial) {
        return function(v) {
            return function(gamma) {
                return function(ix) {
                    if (v instanceof Language_Shape_Stlc_Syntax.TermDefinition && v.value1 instanceof Language_Shape_Stlc_Syntax.ArrowType) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("term-definition definition")
                    ])([
                        renderKeyword()("let"),
                        renderPunctuation()("space"),
                        renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value)),
                        renderPunctuation()("lparen"),
                        Halogen_HTML_Elements.map_(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function(i) {
                            return function(prm) {
                        ...
                        renderPunctuation()("rparen"),
                        renderPunctuation()("colon"),
                        renderType()(new Language_Shape_Stlc_Syntax.BaseType(v.value1.value1))(Language_Shape_Stlc_Context.addUniqueTermBinding(v.value0)(v.value1)(gamma))(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Output.value)),
                        renderPunctuation()("space"),
                        renderPunctuation()("assign"),
                        renderPunctuation()("space"),
                        renderTerm()(v.value2)(v.value1)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))
                    ]);
                    if (v instanceof Language_Shape_Stlc_Syntax.TermDefinition) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("term-definition definition")
                    ])([
                        renderKeyword()("let"),
                        renderPunctuation()("space"),
                    ...
                    if (v instanceof Language_Shape_Stlc_Syntax.DataDefinition) return Halogen_HTML_Elements.div([
                        Halogen_HTML_Properties.class_("data-definition definition")
                    ])([
                        renderKeyword()("data"),
                        renderPunctuation()("space"),
                        renderUniqueTypeBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTypeBinding.value)),
                    ...
                    throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 28, column 1 - line 28, column 89): " + [
                        v.constructor.name,
                        gamma.constructor.name,
                        ix.constructor.name
                    ]);
            ...
            return function(alpha) {
                return function(gamma) {
                    return function(ix) {
                        ...
                        return Halogen_HTML_Elements.div([
                            Halogen_HTML_Properties.class_("block")
                        ])(function() {
                            var $117 = Data_List.length(v.value0) === 0;
                            if ($117) return [
                                intercalateNewlines()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function(i) {
                                    return function(def) {
                                ...
                                renderPunctuation()("newline"),
                                renderTerm()(v.value1)(alpha)(gamma$prime)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))
                            ];
                            return [
                                renderTerm()(v.value1)(alpha)(gamma$prime)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))
                            ];
    ...
    var renderModule = function(dictPartial) {
        return function(v) {
            ...
            return Halogen_HTML_Elements.div([
                Halogen_HTML_Properties.class_("module")
            ])(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_List.mapWithIndex(function(i) {
                return function(def) {
...
(function($PS) {
    ...
    var render = function(dictPartial) {
        return function(st) {
            return Halogen_HTML_Elements.div_([
                Language_Shape_Stlc_Renderer.renderModule()(st.module_)
            ]);
        };
    };
    ...
    var component = Halogen_Component.mkComponent({
        initialState: function(input) {
            return {
                module_: new Language_Shape_Stlc_Syntax.Module(Data_List_Types.Nil.value)
            };
        },
        render: render(),
...
//# sourceMappingURL=index.28bc3d09.js.map
