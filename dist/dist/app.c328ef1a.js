...
(function ($PS) {
  ...
  var UniqueTypeBinding = function () {
    function UniqueTypeBinding(value0) {
      this.value0 = value0;
    }

    ;

    UniqueTypeBinding.create = function (value0) {
      return new UniqueTypeBinding(value0);
    };

    return UniqueTypeBinding;
  }(); // not necessarily unique


  var VariableName = function () {
    function VariableName(value0) {
      this.value0 = value0;
    }

    ;

    VariableName.create = function (value0) {
      return new VariableName(value0);
    };
  ...
  var ConstructorName = function () {
    function ConstructorName(value0) {
      this.value0 = value0;
    }

    ;

    ConstructorName.create = function (value0) {
      return new ConstructorName(value0);
    };
  ...
  var TermLabel = function () {
    function TermLabel(value0) {
      this.value0 = value0;
    }

    ;

    TermLabel.create = function (value0) {
      return new TermLabel(value0);
    };
  ...
  var TermBinding = function () {
    function TermBinding(value0) {
      this.value0 = value0;
    }

    ;

    TermBinding.create = function (value0) {
      return new TermBinding(value0);
    };
  ...
  var UniqueTermBinding = function () {
    function UniqueTermBinding(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    UniqueTermBinding.create = function (value0) {
      return function (value1) {
        return new UniqueTermBinding(value0, value1);
      };
    };

    return UniqueTermBinding;
  }();
  ...
  var HoleType = function () {
    function HoleType(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    HoleType.create = function (value0) {
      return function (value1) {
        return new HoleType(value0, value1);
      };
    };
  ...
  var ArrowType = function () {
    function ArrowType(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    ArrowType.create = function (value0) {
      return function (value1) {
        return new ArrowType(value0, value1);
      };
    };
  ...
  var BaseType = function () {
    function BaseType(value0) {
      this.value0 = value0;
    }

    ;

    BaseType.create = function (value0) {
      return new BaseType(value0);
    };
  ...
  var Parameter = function () {
    function Parameter(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    Parameter.create = function (value0) {
      return function (value1) {
        return new Parameter(value0, value1);
      };
    };
  ...
  var Constructor = function () {
    function Constructor(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    Constructor.create = function (value0) {
      return function (value1) {
        return new Constructor(value0, value1);
      };
    };
  ...
  var TermDefinition = function () {
    function TermDefinition(value0, value1, value2) {
      this.value0 = value0;
      this.value1 = value1;
      this.value2 = value2;
    }
    ...
    TermDefinition.create = function (value0) {
      return function (value1) {
        return function (value2) {
          return new TermDefinition(value0, value1, value2);
        };
      };
    };
  ...
  var DataDefinition = function () {
    function DataDefinition(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    DataDefinition.create = function (value0) {
      return function (value1) {
        return new DataDefinition(value0, value1);
      };
    };
  ...
  var LambdaTerm = function () {
    function LambdaTerm(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    LambdaTerm.create = function (value0) {
      return function (value1) {
        return new LambdaTerm(value0, value1);
      };
    };
  ...
  var NeutralTerm = function () {
    function NeutralTerm(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ...
    NeutralTerm.create = function (value0) {
      return function (value1) {
        return new NeutralTerm(value0, value1);
      };
    };
  ...
  var HoleTerm = function () {
    function HoleTerm(value0) {
      this.value0 = value0;
    }

    ;

    HoleTerm.create = function (value0) {
      return new HoleTerm(value0);
    };
  ...
  var eqTermName = {
    eq: function eq(x) {
      return function (y) {
        ...
        if (x instanceof ConstructorName && y instanceof ConstructorName) {
          return x.value0 === y.value0;
        }
  ...
  var ordTermName = {
    compare: function compare(x) {
      return function (y) {
        ...
        ;
        throw new Error("Failed pattern match at Language.Shape.Stlc.Syntax (line 128, column 1 - line 128, column 29): " + [x.constructor.name, y.constructor.name]);
      };
    },
    Eq0: function Eq0() {
      return eqTermName;
  ...
  exports["LambdaTerm"] = LambdaTerm;
  exports["NeutralTerm"] = NeutralTerm;
  exports["HoleTerm"] = HoleTerm;
  exports["Parameter"] = Parameter;
  exports["TermLabel"] = TermLabel;
  exports["TermBinding"] = TermBinding;
  exports["UniqueTermBinding"] = UniqueTermBinding;
  exports["VariableName"] = VariableName;
  exports["ConstructorName"] = ConstructorName;
  exports["UniqueTypeBinding"] = UniqueTypeBinding;
...
(function ($PS) {
  ...
  var emptyContext = {
    typeNames: Data_List_Types.Nil.value,
    termIdType: Data_Map_Internal.empty,
    termNameIds: Data_Map_Internal.empty,
    termIdName: Data_Map_Internal.empty
  };

  var addTypeName = function addTypeName(name) {
    return function (gamma) {
      return {
        typeNames: new Data_List_Types.Cons(name, gamma.typeNames),
  ...
  var addUniqueTypeBinding = function addUniqueTypeBinding(v) {
    return function (gamma) {
      return addTypeName(v.value0)(gamma);
    };
  };

  var addTermNameId = function addTermNameId(name) {
    return function (id) {
      return function (gamma) {
        return {
          typeNames: gamma.typeNames,
          termIdType: gamma.termIdType,
  ...
  var addTermIdType = function addTermIdType(id) {
    return function (alpha) {
      return function (gamma) {
        return {
          typeNames: gamma.typeNames,
          termIdType: Data_Map_Internal.insert(Data_Ord.ordInt)(id)(alpha)(gamma.termIdType),
          termNameIds: gamma.termNameIds,
          termIdName: gamma.termIdName
        };
      };
  ...
  var addTermIdName = function addTermIdName(id) {
    return function (name) {
      return function (gamma) {
        return {
          typeNames: gamma.typeNames,
          termIdType: gamma.termIdType,
          termNameIds: gamma.termNameIds,
          termIdName: Data_Map_Internal.insert(Data_Ord.ordInt)(id)(name)(gamma.termIdName)
        };
      };
    };
  };

  var addUniqueTermBinding = function addUniqueTermBinding(v) {
    return function (alpha) {
      return function (gamma) {
        return addTermNameId(v.value0)(v.value1.value0)(addTermIdName(v.value1.value0)(v.value0)(addTermIdType(v.value1.value0)(alpha)(gamma)));
      };
    };
  };

  var addDefinitions = function addDefinitions(defs) {
    return function (gamma) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(function (gamma1) {
        return function (v) {
          if (v instanceof Language_Shape_Stlc_Syntax.TermDefinition) {
            return addUniqueTermBinding(v.value0)(v.value1)(gamma1);
          }

          ;

          if (v instanceof Language_Shape_Stlc_Syntax.DataDefinition) {
            return addUniqueTypeBinding(v.value0)(gamma1);
          }

          ;
          throw new Error("Failed pattern match at Language.Shape.Stlc.Context (line 65, column 17 - line 67, column 67): " + [v.constructor.name]);
        };
      })(gamma)(defs);
    };
  };
...
(function ($PS) {
  ...
  var IndexStep_Definition = function () {
    function IndexStep_Definition(value0) {
      this.value0 = value0;
    }

    ;

    IndexStep_Definition.create = function (value0) {
      return new IndexStep_Definition(value0);
    };

    return IndexStep_Definition;
  }();

  var IndexStep_Type = function () {
    function IndexStep_Type() {}

    ;
    IndexStep_Type.value = new IndexStep_Type();
    return IndexStep_Type;
  }();

  var IndexStep_Term = function () {
    function IndexStep_Term() {}

    ;
    IndexStep_Term.value = new IndexStep_Term();
    return IndexStep_Term;
  }();

  var IndexStep_Constructor = function () {
    function IndexStep_Constructor(value0) {
      this.value0 = value0;
    }

    ;

    IndexStep_Constructor.create = function (value0) {
      return new IndexStep_Constructor(value0);
    };

    return IndexStep_Constructor;
  }();

  var IndexStep_Parameter = function () {
    function IndexStep_Parameter(value0) {
      this.value0 = value0;
    }

    ;

    IndexStep_Parameter.create = function (value0) {
      return new IndexStep_Parameter(value0);
    };

    return IndexStep_Parameter;
  }();

  var IndexStep_Output = function () {
    function IndexStep_Output() {}

    ;
    IndexStep_Output.value = new IndexStep_Output();
    return IndexStep_Output;
  }();

  var IndexStep_Block = function () {
    function IndexStep_Block() {}

    ;
    IndexStep_Block.value = new IndexStep_Block();
    return IndexStep_Block;
  }();

  var IndexStep_Argument = function () {
    function IndexStep_Argument(value0) {
      this.value0 = value0;
    }

    ;

    IndexStep_Argument.create = function (value0) {
      return new IndexStep_Argument(value0);
    };

    return IndexStep_Argument;
  }();

  var IndexStep_UniqueTermBinding = function () {
    function IndexStep_UniqueTermBinding() {}

    ;
    IndexStep_UniqueTermBinding.value = new IndexStep_UniqueTermBinding();
    return IndexStep_UniqueTermBinding;
  }();

  var IndexStep_TermBinding = function () {
    function IndexStep_TermBinding(value0) {
      this.value0 = value0;
    }

    ;

    IndexStep_TermBinding.create = function (value0) {
      return new IndexStep_TermBinding(value0);
    };

    return IndexStep_TermBinding;
  }();

  var IndexStep_TermReference = function () {
    function IndexStep_TermReference() {}

    ;
    IndexStep_TermReference.value = new IndexStep_TermReference();
    return IndexStep_TermReference;
  }();

  var IndexStep_TermLabel = function () {
    function IndexStep_TermLabel() {}

    ;
    IndexStep_TermLabel.value = new IndexStep_TermLabel();
    return IndexStep_TermLabel;
  }();

  var IndexStep_UniqueTypeBinding = function () {
    function IndexStep_UniqueTypeBinding() {}

    ;
    IndexStep_UniqueTypeBinding.value = new IndexStep_UniqueTypeBinding();
    return IndexStep_UniqueTypeBinding;
  }();

  var IndexStep_TypeReference = function () {
    function IndexStep_TypeReference() {}

    ;
    IndexStep_TypeReference.value = new IndexStep_TypeReference();
    return IndexStep_TypeReference;
  }();

  var pushIndex = function pushIndex(ix) {
    return function (istep) {
      return Data_Semigroup.append(Data_List_Types.semigroupList)(ix)(Data_List.singleton(istep));
    };
  };

  var appendIndex = function appendIndex(ix) {
    return function (isteps) {
      return Data_Semigroup.append(Data_List_Types.semigroupList)(ix)(isteps);
    };
  };

  exports["IndexStep_Definition"] = IndexStep_Definition;
  exports["IndexStep_Type"] = IndexStep_Type;
  exports["IndexStep_Term"] = IndexStep_Term;
  exports["IndexStep_Constructor"] = IndexStep_Constructor;
  exports["IndexStep_Parameter"] = IndexStep_Parameter;
  exports["IndexStep_Output"] = IndexStep_Output;
  exports["IndexStep_Block"] = IndexStep_Block;
  exports["IndexStep_Argument"] = IndexStep_Argument;
  exports["IndexStep_UniqueTermBinding"] = IndexStep_UniqueTermBinding;
  exports["IndexStep_TermBinding"] = IndexStep_TermBinding;
  exports["IndexStep_TermReference"] = IndexStep_TermReference;
  exports["IndexStep_TermLabel"] = IndexStep_TermLabel;
  exports["IndexStep_UniqueTypeBinding"] = IndexStep_UniqueTypeBinding;
  exports["IndexStep_TypeReference"] = IndexStep_TypeReference;
  exports["pushIndex"] = pushIndex;
  exports["appendIndex"] = appendIndex;
})(PS);
...
(function ($PS) {
  ...
  var renderTypeName = function renderTypeName(name) {
    return Halogen_HTML_Core.text(name);
  };

  var renderTypeReference = function renderTypeReference(v) {
    return function (gamma) {
      return function (ix) {
        return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("typeReference")])([renderTypeName(v.value0)]);
      };
    };
  };

  var renderUniqueTypeBinding = function renderUniqueTypeBinding(v) {
    return function (gamma) {
      return function (ix) {
        return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("uniqueTypeBinding")])([renderTypeName(v.value0)]);
      };
    };
  };

  var renderTermName = function renderTermName(v) {
    if (v instanceof Language_Shape_Stlc_Syntax.VariableName) {
      return Halogen_HTML_Core.text(v.value0);
    }

    ;

    if (v instanceof Language_Shape_Stlc_Syntax.ConstructorName) {
      return Halogen_HTML_Core.text(v.value0);
    }

    ;
    throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 205, column 1 - line 205, column 54): " + [v.constructor.name]);
  };

  var renderUniqueTermBinding = function renderUniqueTermBinding(v) {
    return function (gamma) {
      return function (ix) {
        return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("uniqueTermBinding")])([renderTermName(v.value0)]);
      };
    };
  };

  var renderTermLabel = function renderTermLabel(v) {
    return function (gamma) {
      return function (ix) {
        return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("termLabel")])([renderTermName(v.value0)]);
      };
    };
  };

  var renderHoleId = function renderHoleId(v) {
    return Halogen_HTML_Core.text("?");
  };

  var punctuations = function () {
    var makePunctuation = function makePunctuation(title) {
      return function (punc) {
        return new Data_Tuple.Tuple(title, Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([title, "punctuation"]))])([Halogen_HTML_Core.text(punc)]));
      };
    };
  ...
  var makeIntercalater = function makeIntercalater(dictPartial) {
    return function (inter) {
      var $128 = Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray);
      var $129 = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_List_Types.monoidList)(inter);
      var $130 = Data_Functor.map(Data_List_Types.functorList)(Data_List.singleton);
      return function ($131) {
        return Halogen_HTML_Elements.map_($128($129($130($131))));
      };
    };
  };

  var keywords = function () {
    var makeKeyword = function makeKeyword(title) {
      return new Data_Tuple.Tuple(title, Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([title, " keyword"]))])([Halogen_HTML_Core.text(title)]));
    };
  ...
  var fromJust$prime = function fromJust$prime(dictPartial) {
    return function (v) {
      return function (v1) {
        if (v instanceof Data_Maybe.Just) {
          return v.value0;
  ...
  var intercalateCommas = function intercalateCommas(dictPartial) {
  ...
  var intercalateNewlines = function intercalateNewlines(dictPartial) {
    return makeIntercalater()(Data_List.fromFoldable(Data_Foldable.foldableArray)([renderPunctuation()("newline")]));
  };

  var renderType = function renderType(dictPartial) {
    return function (v) {
      return function (gamma) {
        return function (ix) {
          if (v instanceof Language_Shape_Stlc_Syntax.ArrowType) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("arrow type")])([renderPunctuation()("lparen"), intercalateCommas()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
              return function (prm) {
                return renderParameter()(prm)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_Parameter(i)));
              };
            })(v.value0)), renderPunctuation()("rparen"), renderPunctuation()("space"), renderPunctuation()("arrow"), renderPunctuation()("space"), renderType()(new Language_Shape_Stlc_Syntax.BaseType(v.value1))(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Output.value))]);
          }

          ;

          if (v instanceof Language_Shape_Stlc_Syntax.BaseType && v.value0 instanceof Language_Shape_Stlc_Syntax.DataType) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("data type")])([renderTypeReference(v.value0.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_TypeReference.value))]);
          }

          ;

          if (v instanceof Language_Shape_Stlc_Syntax.BaseType && v.value0 instanceof Language_Shape_Stlc_Syntax.HoleType) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("hole type")])([renderHoleId(v.value0.value0)]);
          }

          ;
          throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 98, column 1 - line 98, column 77): " + [v.constructor.name, gamma.constructor.name, ix.constructor.name]);
        };
      };
    };
  };

  var renderParameter = function renderParameter(dictPartial) {
    return function (v) {
      return function (gamma) {
        return function (ix) {
          return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("parameter")])([renderTermLabel(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_TermLabel.value)), renderPunctuation()("colon"), renderPunctuation()("space"), renderType()(v.value1)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Type.value))]);
        };
      };
    };
  };

  var renderConstructor = function renderConstructor(dictPartial) {
    return function (v) {
      return function (gamma) {
        return function (ix) {
          var $80 = Data_List.length(v.value1) === 0;

          if ($80) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("constructor")])([renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value))]);
          }

          ;
          return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("constructor")])([renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value)), renderPunctuation()("lparen"), intercalateAlts()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
            return function (prm) {
              return renderParameter()(prm)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_Parameter(i)));
            };
          })(v.value1)), renderPunctuation()("rparen")]);
        };
      };
    };
  };

  var renderTermId = function renderTermId(dictPartial) {
    return function (id) {
      return function (gamma) {
        return renderTermName(fromJust$prime()(Data_Map_Internal.lookup(Data_Ord.ordInt)(id)(gamma.termIdName))("renderTermId: " + Data_Show.show(Data_Show.showInt)(id)));
      };
    };
  };

  var renderTermBinding = function renderTermBinding(dictPartial) {
    return function (v) {
      return function (gamma) {
        return function (ix) {
          return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("termBinding")])([renderTermId()(v.value0)(gamma)]);
        };
      };
    };
  };

  var renderTermReference = function renderTermReference(dictPartial) {
    return function (v) {
      return function (gamma) {
        return function (ix) {
          return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("termReference")])([renderTermId()(v.value0)(gamma)]);
        };
      };
    };
  };

  var renderTerm = function renderTerm(dictPartial) {
    return function (v) {
      return function (v1) {
        return function (gamma) {
          return function (ix) {
            if (v instanceof Language_Shape_Stlc_Syntax.LambdaTerm) {
              return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("lambda term")])([renderPunctuation()("lparen"), intercalateCommas()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
                return function (x) {
                  return renderTermBinding()(x)(Undefined["undefined"])(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_TermBinding(i)));
                };
              })(v.value0)), renderPunctuation()("rparen"), renderPunctuation()("space"), renderPunctuation()("arrow"), renderBlock()(v.value1)(v1)(Undefined["undefined"])(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Block.value))]);
            }

            ;

            if (v instanceof Language_Shape_Stlc_Syntax.NeutralTerm && v1 instanceof Language_Shape_Stlc_Syntax.ArrowType) {
              return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("neutral term")])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([renderTermReference()(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_TermReference.value))])(function () {
                var $97 = Data_List.length(v.value1) === 0;
                ...
                return [renderPunctuation()("lparen"), intercalateCommas()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
                  return function (a) {
                    return renderTerm()(a)(function () {
                      var v2 = Data_Function.flip(fromJust$prime())("renderTerm NeutralTerm parameter: " + Data_Show.show(Data_Show.showInt)(i))(Data_List.index(v1.value0)(i));
                      return v2.value1;
                    }())(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_Argument(i)));
                  };
                })(v.value1)), renderPunctuation()("rparen")];
              }()));
            }
            ...
            if (v instanceof Language_Shape_Stlc_Syntax.HoleTerm) {
              return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("hole term")])([renderHoleId(v.value0)]);
            }

            ;
            throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 137, column 1 - line 137, column 85): " + [v.constructor.name, v1.constructor.name, gamma.constructor.name, ix.constructor.name]);
          };
        };
      };
    };
  ...
  var renderDefinition = function renderDefinition(dictPartial) {
    return function (v) {
      return function (gamma) {
        return function (ix) {
          if (v instanceof Language_Shape_Stlc_Syntax.TermDefinition && v.value1 instanceof Language_Shape_Stlc_Syntax.ArrowType) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("term-definition definition")])([renderKeyword()("let"), renderPunctuation()("space"), renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value)), renderPunctuation()("lparen"), Halogen_HTML_Elements.map_(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
              return function (prm) {
                return renderParameter()(prm)(gamma)(Language_Shape_Stlc_Index.appendIndex(ix)(new Data_List_Types.Cons(Language_Shape_Stlc_Index.IndexStep_Type.value, new Data_List_Types.Cons(new Language_Shape_Stlc_Index.IndexStep_Parameter(i), Data_List_Types.Nil.value))));
              };
            })(v.value1.value0))), renderPunctuation()("rparen"), renderPunctuation()("colon"), renderType()(new Language_Shape_Stlc_Syntax.BaseType(v.value1.value1))(Language_Shape_Stlc_Context.addUniqueTermBinding(v.value0)(v.value1)(gamma))(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Output.value)), renderPunctuation()("space"), renderPunctuation()("assign"), renderPunctuation()("space"), renderTerm()(v.value2)(v.value1)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))]);
          }

          ;

          if (v instanceof Language_Shape_Stlc_Syntax.TermDefinition) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("term-definition definition")])([renderKeyword()("let"), renderPunctuation()("space"), renderUniqueTermBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTermBinding.value)), renderPunctuation()("colon"), renderType()(v.value1)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Type.value)), renderPunctuation()("space"), renderPunctuation()("assign"), renderPunctuation()("space"), renderTerm()(v.value2)(v.value1)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))]);
          }

          ;

          if (v instanceof Language_Shape_Stlc_Syntax.DataDefinition) {
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("data-definition definition")])([renderKeyword()("data"), renderPunctuation()("space"), renderUniqueTypeBinding(v.value0)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_UniqueTypeBinding.value)), renderPunctuation()("assign"), intercalateAlts()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
              return function (constr) {
                return renderConstructor()(constr)(gamma)(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_Constructor(i)));
              };
            })(v.value1))]);
          }

          ;
          throw new Error("Failed pattern match at Language.Shape.Stlc.Renderer (line 34, column 1 - line 34, column 89): " + [v.constructor.name, gamma.constructor.name, ix.constructor.name]);
        };
      };
    };
  };

  var renderBlock = function renderBlock(dictPartial) {
    return function (v) {
      return function (alpha) {
        return function (gamma) {
          return function (ix) {
            var gamma$prime = Language_Shape_Stlc_Context.addDefinitions(v.value0)(gamma);
            return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("block")])(function () {
              var $123 = Data_List.length(v.value0) === 0;

              if ($123) {
                return [intercalateNewlines()(Data_FunctorWithIndex.mapWithIndex(Data_List_Types.functorWithIndexList)(function (i) {
                  return function (def) {
                    return renderDefinition()(def)(gamma$prime)(Language_Shape_Stlc_Index.pushIndex(ix)(new Language_Shape_Stlc_Index.IndexStep_Definition(i)));
                  };
                })(v.value0)), renderPunctuation()("newline"), renderTerm()(v.value1)(alpha)(gamma$prime)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))];
              }

              ;
              return [renderTerm()(v.value1)(alpha)(gamma$prime)(Language_Shape_Stlc_Index.pushIndex(ix)(Language_Shape_Stlc_Index.IndexStep_Term.value))];
            }());
          };
        };
      };
  ...
  var renderModule = function renderModule(dictPartial) {
    return function (v) {
      var gamma = Language_Shape_Stlc_Context.addDefinitions(v.value0)(Language_Shape_Stlc_Context.emptyContext);
      return Halogen_HTML_Elements.div([Halogen_HTML_Properties.class_("module")])(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_List.mapWithIndex(function (i) {
        return function (def) {
          return renderDefinition()(def)(gamma)(Data_List.singleton(new Language_Shape_Stlc_Index.IndexStep_Definition(i)));
        };
      })(v.value0)));
    };
  };
...
(function ($PS) {
  ...
  var Language_Shape_Stlc_Renderer = $PS["Language.Shape.Stlc.Renderer"];
  var Language_Shape_Stlc_Syntax = $PS["Language.Shape.Stlc.Syntax"];
  ...
  var render = function render(dictPartial) {
    return function (st) {
      return Halogen_HTML_Elements.div_([Language_Shape_Stlc_Renderer.renderModule()(st.module_)]);
    };
  };

  var initialModule = Language_Shape_Stlc_Syntax.Module.create(Data_List.singleton(Language_Shape_Stlc_Syntax.DataDefinition.create(new Language_Shape_Stlc_Syntax.UniqueTypeBinding("Nat"))(Data_List.fromFoldable(Data_Foldable.foldableArray)([new Language_Shape_Stlc_Syntax.Constructor(new Language_Shape_Stlc_Syntax.UniqueTermBinding(new Language_Shape_Stlc_Syntax.ConstructorName("Zero"), new Language_Shape_Stlc_Syntax.TermBinding(0)), Data_List_Types.Nil.value), Language_Shape_Stlc_Syntax.Constructor.create(new Language_Shape_Stlc_Syntax.UniqueTermBinding(new Language_Shape_Stlc_Syntax.ConstructorName("Suc"), new Language_Shape_Stlc_Syntax.TermBinding(0)))(Data_List.fromFoldable(Data_Foldable.foldableArray)([new Language_Shape_Stlc_Syntax.Parameter(new Language_Shape_Stlc_Syntax.TermLabel(new Language_Shape_Stlc_Syntax.VariableName("n")), new Language_Shape_Stlc_Syntax.BaseType(new Language_Shape_Stlc_Syntax.DataType(new Language_Shape_Stlc_Syntax.TypeReference("Nat"))))]))]))));
