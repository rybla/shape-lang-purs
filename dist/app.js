...
(function($PS) {
  ...
  var punctuations = (function () {
      var makePunctuation = function (title) {
          return function (punc) {
              return new Data_Tuple.Tuple(title, Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ title, "punctuation" ])) ])([ Halogen_HTML_Core.text(punc) ]));
          };
      };
  ...
  var keywords = (function () {
      var makeKeyword = function (title) {
          return new Data_Tuple.Tuple(title, Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ title, " keyword" ])) ])([ Halogen_HTML_Core.text(title) ]));
      };
